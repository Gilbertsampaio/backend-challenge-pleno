    ...
    <section class="home">
        <div class="col-xxl-8 px-4">
            <div class="row flex-lg-row-reverse align-items-center">
                ...
                <div class="col-lg-4 novo" style="margin-top:-350px;">
                    <h3 class="fw-bold lh-1 mb-3 titulo" style="font-size: 30px;">Editar</h3>
...
<svg viewBox="0 0 1366 354" role="presentation" class="Wave-module__wrapper--1-9Ka novo" data-test="Wave">
