    ...
    <section>
        <div class="col-xxl-8 px-4">
            <div class="row flex-lg-row-reverse align-items-center">
                ...
                <div class="col-lg-4" style="text-align: left; margin-top:-350px; padding-right: 80px;">
                    <h3 class="fw-bold lh-1 mb-3 titulo" style="margin: 10px 0 30px 0 !important; font-size: 30px;">Editar</h3>
                    <form class="form" action="../save/<?=$id_tarefa;?>" method="post" autocomplete="off">
                        <div class="col-md-12">
                            <div class="input-group mb-10">
                                <span class="input-group-text">Nome tarefa<small>*</small></span>
                                <input autocomplete="off" type="text" class="form-control text-dark" name="nome_tarefa" value="<?=$tarefa["nome_tarefa"];?>">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="input-group mb-10">
                                <span class="input-group-text">Prioridades<small>*</small></span>
                   ...
                   echo "<option value='".$id."'".$selected.">".$prioridade."</option>";
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-10">
                                <span class="input-group-text">Status<small>*</small></span>
                   ...
                   echo "<option value='".$id."'".$selected.">".$st."</option>";
                        ...
                        <div class="col-md-12">
                            <div class="input-group mb-10">
                                <span class="input-group-text">Colaborador<small>*</small></span>
                   ...
                   echo "<option value='".$pes['id_pessoa']."'".$selected.">".$pes["nome"]."</option>";
                        ...
                        <button type="submit" class="btn btn-success btn-lg fs-14 plr pulsaSuccess w-100">Salvar</button>
                    </form>
                </div>
            </div>
        </div>
