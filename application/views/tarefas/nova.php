        ...
        <div class="col-xxl-8 px-4">
            <div class="row flex-lg-row-reverse align-items-center">
                ...
                <div class="col-lg-4" style="text-align: left; margin-top:-350px; padding-right: 80px;">
                    <h3 class="fw-bold lh-1 mb-3 titulo" style="margin: 10px 0 30px 0 !important; font-size: 30px;">Cadastro</h3>
                    <?php 
                        if(isset($error)){
                    ...
                    <form class="form" method="post" action="add" autocomplete="off">
                        <div class="col-md-12">
                            <div class="input-group mb-10">
                                ...
                                <input autocomplete="off" type="text" class="form-control text-dark" name="nome_tarefa">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="input-group mb-10">
                        ...
                        <button type="submit" id="botNova" class="btn btn-success btn-lg fs-14 plr pulsaSuccess w-100 disabled">Salvar</button>
                    </form>
                </div>
            </div>
        </div>
