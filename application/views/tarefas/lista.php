        ...
        <div class="col-xxl-8 px-4">
            <div class="row flex-lg-row-reverse align-items-center">
                ...
                <div class="col-lg-5 listaMobile" style="margin-top:-270px;">
                    <form class="form none" style="margin-right: 0 !important; margin-top:20px" id="excluir_form" action="tarefas/excluir" method="post" autocomplete="off">
                        ...
                        <table class="table table-dark table-hover">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th>Status</th>
                                    <th>Pessoa</th>
                                    <th colspan="2" style="max-width:50px; padding-right:20px">Ações</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                                foreach ($tarefas as $tarefa) {
                                    ...
                                    echo "<tr>";
                                    echo "<td style='min-width:250px; text-align:left; padding-left:20px'>" . $tarefa['nome_tarefa'] . "</td>";
                                    ...
                                    echo "<td class='center'style='min-width:60px; padding-right:20px'><button onclick='excluir(" . $id . ", \"" . $tarefa['nome_tarefa'] . "\")' class='btn btn-danger'><i style='font-size:14px' class='mdi mdi-delete'></i></button></td>";
                                    echo "</tr>";
                                }
                                ?>
                            </tbody>
