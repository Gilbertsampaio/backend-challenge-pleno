...
<div class="container" style="height:100%; position: absolute;">
    <section style="padding:20px; margin-bottom: 0">
        <div class="row">
            <h3 class="fw-bold lh-1 mb-3 titulo" style="margin: 10px 0 30px 0 !important; font-size: 30px;">Listagem de Tarefas</h3>
            <div class="col-lg-12 tabela" style="">
                ...
                <form class="form none" id="excluir_form" action="tarefas/excluir" method="post" autocomplete="off">
                    ...
                    <div class="alert alert-warning alert-dismissible fade show" role="alert">
                        Deseja excluir a seguinte a tarefa <strong><span id='excluir_name'></span>?</strong>
                        <p class="card-text" style="margin-top:20px">
                            <button type="button" id="hide_del_form" class="btn btn-danger">Não</button>
                ...
                <table class="table table-dark table-hover">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>Status</th>
                            <th>Pessoa</th>
                            <th colspan="2" style="max-width:50px">Ações</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php 
