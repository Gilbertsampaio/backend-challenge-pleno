    ...
    function modalDoc() {
      ...
      elemento.find('.modal-body').html(`<div class="row">
                                          ...
                                          <div class="col-md-6 center">
                                              <a class="doc" href="../public/files/Curriculo-2021-floripa.docx" download><img style="height:100px" src="../public/img/word.png" /></a>
                                          </div>
                                          <div class="col-md-6 center">
                                              <a class="doc" href="../public/files/Curriculo-2021-floripa.pdf" download><img style="height:100px" src="../public/img/pdf.png" /></a>
                                          </div>
                                      </div>`);
      elemento.find('.modal-footer').html(`
                                          <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Fechar</button>`);
